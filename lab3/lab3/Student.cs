...
{
    if (N is GameDevelopment)
    {
        Console.WriteLine((N as GameDevelopment).PrintTrainees());
    }
    else if (N is MobileApplicationDevelopment)
    {
        Console.WriteLine((N as MobileApplicationDevelopment).PrintTrainees());
    }
    else if (N is DataScience)
    {
        Console.WriteLine((N as DataScience).PrintTrainees());
    }
}
